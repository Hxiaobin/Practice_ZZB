...
import static com.sf.bocfinancialsoftware.constant.URLConfig.GUARANTEE_MESSAGE_LIST_URL;
...
public class GuaranteeMessageListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener {
    ...
    public void onRefresh() {
        ...
        if (map.get(QUERY_FILTER) == null) { //没有筛选条件
            ...
            map.put(QUERY_PAGE, String.valueOf(page)); //查询页码
            getNetworkData(GUARANTEE_MESSAGE_LIST_URL, map, strSuccess, strError, REQUEST_FROM_REFRESH);
        }
    }
        ...
        if (scrollState == SCROLL_STATE_IDLE && isLastLine) { //停止滚动，且滚动到最后一行
            if (hasNext.equals(HAS_NOT_NEXT)) { // 如果没有下一页
                ...
                if (map.get(QUERY_FILTER) == null) { //没有筛选条件
                    ...
                    map.put(QUERY_FILTER, filter);
                    map.put(QUERY_PAGE, String.valueOf(page));
                    getNetworkData(GUARANTEE_MESSAGE_LIST_URL, map, strSuccess, strError, REQUEST_FROM_LOAD_MORE);
                }
            }
        }
    }
    ...
    public void getNetworkData(String url, final HashMap<String, String> mapObject, final String success, final String error, final String flag) {
        HttpUtil.getNetworksJSonResponse(GuaranteeMessageListActivity.this, url, mapObject, new HttpCallBackListener() {
            @Override
            public void onSuccess(String response) {
                ...
                Toast.makeText(GuaranteeMessageListActivity.this, success, Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFailed(String msg) {
                ...
                lltLoadMore.setVisibility(View.GONE); //隐藏正在加载
                Toast.makeText(GuaranteeMessageListActivity.this, error, Toast.LENGTH_SHORT).show();
            }
            ...
            public void onError(Exception e) {
                ...
                lltLoadMore.setVisibility(View.GONE); //隐藏正在加载
                Toast.makeText(GuaranteeMessageListActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
